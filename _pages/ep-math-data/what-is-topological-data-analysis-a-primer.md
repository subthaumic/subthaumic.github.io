...
A pedagogical introduction to the corresponding numerics is given in a separate numerical [tutorial](https://wiki.structures.mathi.uni-heidelberg.de/index.php?title=GUDHI_Tutorial), in which respective C++ code is detailed which implements the approach presented here.

## From point cloud to Delaunay complex
![Example point cloud consisting of noisy samples from a circle in the plane.](/assets/img/ep-math-data/Two-dimensional_Point_cloud.png)
...
![Left panel: the Voronoi diagram of the example point cloud. Right panel: the corresponding Delaunay complex, printed on top of the Voronoi diagram.](/assets/img/ep-math-data/Voronoi_delaunay.png)
...
![Alpha shapes of radii 0.1, 0.2, 0.5 and 1.0, from left to right, respectively, of the example point cloud.](/assets/img/ep-math-data/AlphaShapes.png)
...
![The persistence diagram of the example point cloud, displaying death versus birth radii of all non-trivial persistent homology classes.](/assets/img/ep-math-data/PersistenceDiagram.png)
