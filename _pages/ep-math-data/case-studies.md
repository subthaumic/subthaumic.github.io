...
![The anisotropies in temperature and polarization of the cosmic microwave background, or CMB, as observed by ESA’s Planck mission. Picture taken from the ESA webpage.](/assets/img/ep-math-data/CMB_ESA.jpg)
...
![The London Underground. Public domain picture taken from Wikipedia.](/assets/img/ep-math-data/Underground.png)
...
![Schematically drawn, crystalline structures (left) are characterized by long-range order, while amorphous structures (right) do not exhibit this type of order. Picture taken from monq.com.](/assets/img/ep-math-data/Crystalline_vs_amorphous_structures.jpg)
...
![A schematic drawing of an outcoming graph of the Mapper-algorithm.](/assets/img/ep-math-data/Mapper.png)
#### Introduction
